...
namespace SXF.Utils
{
    ...
    public abstract class FileManager
    {
        ...
        #region 根据网页路径获取网址在网站中的绝对路径
        /// <summary>
        /// 适合进程用的获取物理路径的方法，因为在进程中server.mappath不能使用
        /// </summary>
        /// <param name="strPath">以斜杠开头的网页路径，不能使用父路径形式</param>
        /// <returns></returns>
        public static string GetPhysicsPath(string strPath)
        {
            string str = TextUtility.AddLast(AppDomain.CurrentDomain.BaseDirectory, @"\");
        ...
        /// <summary>
        /// 获取一个目录的物理路径（适用于网页中获取）
        /// </summary>
        /// <param name="folderPath">目录路径</param>
        /// <returns></returns>
        public static string GetPhysicsPathByWebpage(string folderPath)
        {
            ...
            return TextUtility.AddLast(HttpContext.Current.Server.MapPath(str2 + folderPath), @"\");
        }

        /// <summary>
        /// 适用于网页路径的获取和进程网页路径的获取
        /// </summary>
        /// <param name="strPath"></param>
        /// <returns></returns>
        public static string GetPhysicsRealPath(string strPath)
        {
