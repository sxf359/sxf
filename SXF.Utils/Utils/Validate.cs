namespace SXF.Utils
{
    ...
    public sealed class Validate
    {
        ...
        //昵称为6-12位字母数字下划线组成
        private static readonly Regex regex_IsNickName = new Regex(@"^[a-zA-Z\d_]{6,12}$", RegexOptions.IgnoreCase);
        //密码为6-16位字母数字下划线组成
        private static readonly Regex regex_IsPassword = new Regex(@"^[a-zA-Z\d_]{6,16}$", RegexOptions.Compiled);
        ...
        //二级域名是否是字母和数字的组合
        private static readonly Regex regex_IsMyDomain = new Regex("^[0-9A-Za-z]{3,30}$", RegexOptions.Compiled);
        ...
        /// <param name="strVal"></param>
        /// <returns></returns>
        public static bool IsPassword(string strVal)
        {
            return regex_IsPassword.IsMatch(strVal);
        }
        ...
        /// <returns></returns>
        public static bool IsMyDomain(string str)
        {
            return regex_IsMyDomain.IsMatch(str);
        }
    }
}
