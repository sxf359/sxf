...
namespace SXF.Utils.MVC
{
    ...
    public class CompareValuesAttribute : ValidationAttribute
    {
        ...
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            var memberName = validationContext.MemberName;  //获取成员名
            //EventLog.WriteLog("m1:" + memberName);
            if (memberName == null)
            {
                //memberName = validationContext.DisplayName;
                // memberName = validationContext.MemberName;
                //EventLog.WriteLog("m2:" + memberName);
                return new ValidationResult(String.Format("MemberName is not null."));
            }
