namespace SXF.Kernel
{
    ...
    public class MessageHelper
    {
        ...
        {
            //SinoHelper2.EventLog.WriteLog(prams[prams.Count - 1].Value.ToString());
            //SinoHelper2.EventLog.WriteLog(prams[prams.Count - 2].Value.ToString());

            //SinoHelper2.EventLog.WriteLog(prams[prams.Count - 1].ToString());
            //SinoHelper2.EventLog.WriteLog(prams[prams.Count - 2].ToString());
        ...
        /// </summary>
        /// <param name="database"></param>
        /// <param name="procaName"></param>
        /// <param name="param"></param>
        /// <returns></returns>
        public static Message GetMessageTrans(DbHelper database, string procaName, List<DbParameter> param)
        {
            param.Add(database.MakeReturnParam());
            database.RunTrans(procaName, param.ToArray());
